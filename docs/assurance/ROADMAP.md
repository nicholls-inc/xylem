...
| 7 | `intent-check` workflow phase (claimcheck-analog) | 1 week | [next/07-intent-check-phase.md](next/07-intent-check-phase.md) — **In progress** (2026-04-21): `xylem-intent-check` binary + prompts + attestation hook + seeded mismatch fixture shipped in PR 1; workflow YAML integration (PR 2) requires human-authored amendment |
