...
**Status:** In progress — PR 1 open (binary + prompts + attestation hook + seeded fixture + docs); PR 2 pending human-authored workflow YAML amendments (see `docs/assurance/next/07-workflow-amendments-draft.md`)
