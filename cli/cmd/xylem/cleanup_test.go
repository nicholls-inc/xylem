...
func TestCleanupDryRunWithWorktrees(t *testing.T) {
	porcelain := strings.Join([]string{
		...
		"",
		"worktree /repo/.xylem/worktrees/fix/issue-1-bug",
		"HEAD bbb",
		"branch refs/heads/fix/issue-1-bug",
		"",
		"worktree /repo/.xylem/worktrees/feat/issue-2-feature",
		"HEAD ccc",
...
func TestCleanupActualRemoval(t *testing.T) {
	porcelain := strings.Join([]string{
		...
		"branch refs/heads/main",
		"",
		"worktree /repo/.xylem/worktrees/fix/issue-5-test",
		"HEAD bbb",
...
func TestCleanupSkipsActiveWorktreeWhenQueuePathIsRelative(t *testing.T) {
	...
	if _, err := q.Enqueue(queue.Vessel{
		...
		WorktreePath: filepath.Join(".xylem", "worktrees", "fix", "issue-1-bug"),
	}); err != nil {
...
func TestCleanupRemovalError(t *testing.T) {
	porcelain := strings.Join([]string{
		...
		"branch refs/heads/main",
		"",
		"worktree /repo/.xylem/worktrees/fix/issue-7-broken",
		"HEAD bbb",
...
func TestCleanupPartialFailure(t *testing.T) {
	porcelain := strings.Join([]string{
		...
		"branch refs/heads/main",
		"",
		"worktree /repo/.xylem/worktrees/fix/issue-1-ok",
		"HEAD bbb",
		"branch refs/heads/fix/issue-1-ok",
		"",
		"worktree /repo/.xylem/worktrees/fix/issue-2-fail",
		"HEAD ccc",
