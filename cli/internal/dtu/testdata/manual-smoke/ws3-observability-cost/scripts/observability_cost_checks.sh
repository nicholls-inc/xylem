...
go test -count=1 ./internal/observability -run '^(TestSmoke_S(1_|2_|3_|4_|5_|6_|7_).+|TestNewTracer(WithEndpoint|WithEndpointShutdown|NoEndpointReturnsError|Shutdown))$'
